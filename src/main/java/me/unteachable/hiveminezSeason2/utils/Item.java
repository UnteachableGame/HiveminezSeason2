...
public class Item extends ItemStack {
    ...
    public ItemStack createItem() {
        ...
        if (displayName != null) {
            String finalTitle = (displayStringFormat != null && displayStringFormat.length > 0)
                    ? prefix.setHexStringFormat(displayName, displayStringFormat)
                    : prefix.translateColorCodes(displayName);
        ...
        if (lore != null) {
            ...
            for (String line : lore) {
                if (loreStringFormat != null && loreStringFormat.length > 0) {
                    loreList.add(prefix.setHexStringFormat(line, loreStringFormat));
                } else {
